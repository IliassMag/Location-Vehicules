...
public class PanelGauche extends JPanel {
    ...
    //  p1.setBackground(Color.lightGray);
		...
		JLabel img1 = new JLabel(new ImageIcon("D:\\jee project\\Gestion de location des véhicules\\src\\prog.gif"));
		
		this.b1 = new JButton("Gestion des véhicules",new ImageIcon("D:\\\\jee project\\\\Gestion de location des véhicules\\\\src\\\\voii.jpg"));
...
//		b2.setFont( new Font( "Bradley Hand ITC", Font.PLAIN,20));
		this.b3 = new JButton("Gestion des contracts",new ImageIcon("D:\\\\jee project\\\\Gestion de location des véhicules\\\\src\\\\cont.png"));
		b3.setFont( new Font( "Bradley Hand ITC", Font.PLAIN,20));
		this.b4 = new JButton("Gestion de caisse",new ImageIcon("D:\\\\jee project\\\\Gestion de location des véhicules\\\\src\\\\cai.gif"));
		b4.setFont( new Font( "Bradley Hand ITC", Font.PLAIN,20));
	     b5=new JButton("Gestion de Location",new ImageIcon("D:\\\\jee project\\\\Gestion de location des véhicules\\\\src\\\\lockey.jpg"));
