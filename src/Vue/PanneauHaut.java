...
public class PanneauHaut extends JToolBar{
	...
	//	p1 = new JPanel();
		...
		b1 = new JButton("Ajouter une véhicule ",new ImageIcon("D:\\\\jee project\\\\Gestion de location des véhicules\\\\src\\\\lvs.jpg"));
		...
		b2=new JButton("Rechercher",new ImageIcon("D:\\\\jee project\\\\Gestion de location des véhicules\\\\src\\\\lente.png"));
		b2.setFont( new Font( "Bradley Hand ITC", Font.ROMAN_BASELINE,20));
		b2.setBackground(Color.WHITE);
		b3=new JButton("Liste des Locations",new ImageIcon("D:\\\\jee project\\\\Gestion de location des véhicules\\\\src\\\\listeLoc.png"));
		...
		this.b4 = new JButton("Liste des clients",new ImageIcon("D:\\\\jee project\\\\Gestion de location des véhicules\\\\src\\\\cl.jpg"));
